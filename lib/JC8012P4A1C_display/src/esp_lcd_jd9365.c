...
// Export for use by bounce buffer mode
...
const size_t vendor_specific_init_default_size = sizeof(vendor_specific_init_default) / sizeof(vendor_specific_init_default[0]);
