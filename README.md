...
## Home Assistant stability 1.4.1
...
See [1.4.1 release notes](docs/RELEASE_1.4.1.md) for command recovery and validation, and [1.4.0 release notes](docs/RELEASE_1.4.0.md) for room configuration.
