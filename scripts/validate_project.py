...
required=[
    ...
    "docs/RELEASE_1.3.10.md", "docs/RELEASE_1.4.0.md", "include/display_text.h", "src/room_config.cpp",
...
assert '#define APP_VERSION "1.4.0"' in app
...
print("Home Control Panel v1.4.0 structure validation passed.")
